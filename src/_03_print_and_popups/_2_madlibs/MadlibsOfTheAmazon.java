...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String input = JOptionPane.showInputDialog("List an adjective.");
		// Get the player to enter a type of liquid
		String input3 = JOptionPane.showInputDialog("List a form of liquid.");
		// Get the player to enter a body part
		String input1 = JOptionPane.showInputDialog("List a body part.");
		// Get the player to enter a verb
		String input2 = JOptionPane.showInputDialog("List a verb.");
		// Get the player to enter a place
		String input4 = JOptionPane.showInputDialog("List a place.");
		...
		"night. Piranhas are attracted to fresh " + ( input3 ) + " and will most\n"  +
		"likely take a bite out of your " + ( input1 ) + " if you " + ( input2 ) + ". Whatever\n"  +
