	...
	int dragonAttack=0;
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
			String input1 = JOptionPane.showInputDialog("Attack dragon with a yell or a kick?");
			...
			// ASSESS THE DAMAGE
				...
				// 		dragon have left.
				JOptionPane.showMessageDialog(null, "Dragon:"+dragonHealth+" Player:"+playerHealth);
